package com.yiyibook.yiyibook.Activity;
...
import com.yiyibook.yiyibook.Model.LoginInfo;
import com.yiyibook.yiyibook.Model.LoginResponse;
import com.yiyibook.yiyibook.R;
import com.yiyibook.yiyibook.Utils.netutil.FastJsonRequest;
import com.yiyibook.yiyibook.Utils.netutil.JavaBeanRequest;
import com.yiyibook.yiyibook.Utils.netutil.ServerHelper;
...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void requestLogin(final String account, final String password) {
        ...
        Observable.create(new ObservableOnSubscribe<LoginResponse>() {
            @Override
            public void subscribe(ObservableEmitter<LoginResponse> emitter){
                ...
                subscribe(new Consumer<LoginResponse>() {
                    ...
                    public void accept(LoginResponse loginResponse) {
                        String code = loginResponse.getResultCode();
                        String msg = loginResponse.getErrorMessage();
                        if (ServerHelper.OK.equals(code)) {
                            showProgress(false);
                            intentHome();
                        } else {
                            Logger.e("网络返回错误");
